...
<section class="product-case">
			<div class="container">
				<div class="row">
				<div class="col-3 <?php if($GLOBALS[navclassid] == 1 || $GLOBALS[navclassid] == 2){?>active<?}?>"><a href="/product/crusher/">破碎设备</a></div>
				<div class="col-3 <?php if($GLOBALS[navclassid] ==3){?>active<?}?>"><a href="/product/sand/">制砂设备</a></div>
				<div class="col-3 <?php if($GLOBALS[navclassid] ==4){?>active<?}?>"><a href="/product/mobile/">移动破碎站</a></div>
				<div class="col-3 <?php if($GLOBALS[navclassid] ==5){?>active<?}?>"><a href="/product/mill/">磨粉设备</a></div>
			</div>
			</div>
		...
		<section class="product-list">
			<div class="container">
				<div class="wrapper">
					<div class="row">
						<div class="col-4"><img class="width-fill" src="/images/product/pfw.jpg" alt="世邦宣传片"><div class="text">HGT系列<br>
						旋回式破碎机</div>	</div>
						<div class="col-4"><img class="width-fill" src="/images/product/pfw.jpg" alt="世邦宣传片"><div class="text">HGT系列<br>
						旋回式破碎机</div></div>
						<div class="col-4"><img class="width-fill" src="/images/product/pfw.jpg" alt="世邦宣传片"><div class="text">HGT系列<br>
