...
$ecms_config['db']['dbname']='zenithcn';	//数据库名
...
//后台安全设置
$ecms_config['esafe']['loginauth']='416';	//登录认证码,如果设置登录需要输入此认证码才能通过
$ecms_config['esafe']['enloginauth']=0;	//登录认证码加密验证串有效时间,单位:秒(0为不启用加密)
$ecms_config['esafe']['ecookiernd']='nZGTz2BSkm74yaD5WA4JE11br0QZoKepq08N';	//后台登录COOKIE认证码(填写10~50个任意字符，最好多种字符组合)
...
$ecms_config['cks']['ckvarpre']='pstfj';		//前台cookie变量前缀
$ecms_config['cks']['ckadminvarpre']='fzhzq';		//后台cookie变量前缀
$ecms_config['cks']['ckrnd']='wjlWWJiZYWQ9cloVXi2sMydPHtNKy0MUCKX';	//COOKIE验证随机码(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndtwo']='ztX1DG1VVVPuPGVMu2QtqtyePTKqNFatAz';	//COOKIE验证随机码2(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndthree']='8HD93OrrsIomEwtZAVEJTeMkAQibsKrIe';	//COOKIE验证随机码3(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndfour']='OY3D1L1DFHTVH9jeff6XmvLpzYR3MkY0';	//COOKIE验证随机码4(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndfive']='jWG7NLhvKeFA6SuHnrVvLGy9CYCksur';	//COOKIE验证随机码5(填写10~50个任意字符，最好多种字符组合)
...
'keytog'=>2,
'keytime'=>900,
'keyrnd'=>'7Pl1eBiIDAQQbu62n9wvCeE9nZsUC7Q1',
...
'fbkey_ok'=>0,
'newaddinfotime'=>0,
'classnavs'=>'<a href=\"http://172.16.0.254/product/\">产品</a>&nbsp;|&nbsp;<a href=\"http://172.16.0.254/about/\">关于西芝</a>&nbsp;|&nbsp;<a href=\"http://172.16.0.254/contact/\">联系我们</a>&nbsp;|&nbsp;<a href=\"http://172.16.0.254/huace/\">画册</a>&nbsp;|&nbsp;<a href=\"http://172.16.0.254/case/\">案例</a>',
'adminstyle'=>',1,2,',
'docnewsnum'=>300,
'openschall'=>0,
'schallfield'=>1,
...
'bakescapetype'=>1,
'hkeytime'=>30,
'hkeyrnd'=>'uwS1IdChWjqBLDWlArIafMhsX8o1ZYCi7uXs',
'mhavedatedo'=>0,
'reportkey'=>0,
'ctimeopen'=>0,
'ctimelast'=>0,
...
'ctimegids'=>'',
'ctimecids'=>'',
'ctimernd'=>'ISIQo0WKV28ntmZ8nbkPKitDWc7QFMUmuaCNiRDgeY',
'qmadminuids'=>'',
'qmforumuids'=>'',
'qmotheruids'=>'',
'ckhavemoreport'=>0,
...
'intb'=>0,
'mid'=>7);
$etable_r['products']=Array('deftb'=>'1',
'yhid'=>0,
'intb'=>0,
'mid'=>9);
...
'datatbs'=>',1,',
'deftb'=>'1',
'enter'=>',title,special.field,titlepic,newstime,seotitle,smalltext,relatedmaterial,productgood,relatedcase,relatedproduct,',
'qenter'=>',',
'listtempf'=>',',
'tempf'=>',',
'mustqenterf'=>',title,',
...
'searchvar'=>'',
'cj'=>',title,',
'canaddf'=>',title,titlepic,newstime,seotitle,smalltext,relatedmaterial,productgood,relatedcase,relatedproduct,',
'caneditf'=>',title,titlepic,newstime,seotitle,smalltext,relatedmaterial,productgood,relatedcase,relatedproduct,',
'tbmainf'=>',relatedproduct,relatedcase,productgood,relatedmaterial,smalltext,newstime,seotitle,titlepic,title,',
'tbdataf'=>',',
'tobrf'=>',',
'dohtmlf'=>',relatedproduct,relatedcase,productgood,relatedmaterial,smalltext,seotitle,',
'checkboxf'=>',',
'savetxtf'=>'',
'editorf'=>',',
'ubbeditorf'=>',',
...
'datatbs'=>',1,',
'deftb'=>'1',
'enter'=>',title,special.field,newstime,seotitle,smalltext,relatedmaterial,productgood,relatedcase,relatedproduct,',
'qenter'=>',',
'listtempf'=>',',
'tempf'=>',',
'mustqenterf'=>',title,',
